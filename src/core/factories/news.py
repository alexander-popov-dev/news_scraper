...
class NewsControllerFactory:
    ...
    def create(self) -> NewsController:
        return NewsController(
            ...
            profile_id=self._site_dto.browser_provider.profile_id if self._site_dto.browser_provider else None,
            folder_id=self._site_dto.browser_provider.folder_id if self._site_dto.browser_provider else None,
