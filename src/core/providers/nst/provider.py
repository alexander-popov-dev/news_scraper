...
from server.settings import NST_BROWSER_SERVER_IP, NST_BROWSER_SERVER_PORT, NST_BROWSER_API_KEY
    ...
    def stop(self) -> None:
        if self._close_profile:
            ...
            with RequestsClient() as client:
                ...
                logger.info(f'NST Browser profile {self._profile_id} successfully stopped')
